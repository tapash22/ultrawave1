<template>
  <div class="graphics">
    <div class="container">
      <h3>Our Works</h3>
      <div class="row">
        <div class="col-md-6" v-for="gph in graphics" :key="gph.id">
          <div class="card">
            <img :src="gph.image" />
          </div>
        </div>
...
.graphics .row .col-md-6 .card img {
  width: 100%;
  height: 100%;
  padding: 0;
  margin: 0;
...
.graphics .row .col-md-6 img:hover {
  cursor: pointer;
  transform: scale(0.9);
